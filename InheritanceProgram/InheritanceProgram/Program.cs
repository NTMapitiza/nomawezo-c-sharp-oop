...
namespace InheritanceProgram
{
    public class Shopper
    {
        ...
        public virtual string GetDisplayShopperInfo(string sep) =>
           ID + sep + Age + sep + Gender;
        ...
        public class Mystery : Shopper
        {
            ...
            public override string GetDisplayShopperInfo(string sep) =>
                base.GetDisplayShopperInfo(sep) + "( " + this.Area + ")";
        }
        ...
        public class Regular : Shopper
        {
            ...
            public override string GetDisplayShopperInfo(string sep) =>
                base.GetDisplayShopperInfo(sep) + "( " + this.Name + ")";
        }
